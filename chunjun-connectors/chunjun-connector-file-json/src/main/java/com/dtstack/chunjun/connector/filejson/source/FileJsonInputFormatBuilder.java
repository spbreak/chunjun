 ...
 * @create: 2021/06/24
 */
public class FileJsonInputFormatBuilder extends BaseRichInputFormatBuilder<FileJsonInputFormat> {

    public FileJsonInputFormatBuilder() {
        super(new FileJsonInputFormat());
    }

    public void setFileJsonConf(BaseFileConf fileConf) {
        super.setConfig(fileConf);
        format.setFileJsonConf(fileConf);
    }

    @Override
    protected void checkFormat() {

        BaseFileConf fileConf = format.getFileJsonConf();
