 ...
 * @create: 2021/06/24
 */
public class FileJsonRowConverter
        extends AbstractRowConverter<String, String, String, LogicalType> {

    private DeserializationSchema<RowData> valueDeserialization;

    public FileJsonRowConverter(DeserializationSchema<RowData> valueDeserialization) {
